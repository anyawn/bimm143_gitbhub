---
title: "Class 8: Breast Mini Project"
...
Today's lab we will work with fine needle aspiration (FNA) of a breast mass data from the University of Wisconsin. 
...
Yes, we need to scale the data. We wil run 'prcomp()' with 'scale=TRUE'.
...
To get my cluster result/membership factor, I need to "cut" the tree wth the 'cutree()' function. 
